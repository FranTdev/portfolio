    ...
    <footer class="w-full bg-surface-container-lowest border-t border-white/5 py-12">
      <div class="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-6">
        <div class="flex flex-col items-center md:items-start gap-2">
          <div class="font-label-caps text-xs text-on-surface-variant">Hosted on GitHub Pages • Built with Vite & Tailwind CSS</div>
          <div class="text-xs text-text-muted">© ${currentYear} ${profileData.name}. All systems operational.</div>
        </div>
